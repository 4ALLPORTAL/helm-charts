...
![Version: 34.0.0](https://img.shields.io/badge/Version-34.0.0-informational?style=flat-square)
...
| Name | Email | Url |
| ---- | ------ | --- |
| Chris Werner Rau | <c.rau@4allportal.net> |  |

## Requirements

| Repository | Name | Version |
|------------|------|---------|
| https://charts.bitnami.com/bitnami | common | 1.13.1 |
