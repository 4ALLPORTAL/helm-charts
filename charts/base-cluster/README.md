...
| global.helm.image.tag | string | `"3.12.0"` |  |
...
This release removes everything related to the deadMansSwitch function. In order to migrate you have to delete the value block .Values.monitoring.deadMansSwitch
