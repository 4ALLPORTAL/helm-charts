...
![Version: 34.8.1](https://img.shields.io/badge/Version-34.8.1-informational?style=flat-square)
...
| global.helm.image.tag | string | `"3.9.0"` |  |
...
| global.kubectl.image.tag | string | `"1.24.2"` |  |
