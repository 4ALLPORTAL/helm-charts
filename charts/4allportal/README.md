...
![Version: 16.2.0](https://img.shields.io/badge/Version-16.2.0-informational?style=flat-square) ![AppVersion: 3.10.8](https://img.shields.io/badge/AppVersion-3.10.8-informational?style=flat-square)
...
| Name | Email | Url |
| ---- | ------ | --- |
| Chris Werner Rau | <c.rau@4allportal.com> |  |

## Requirements

| Repository | Name | Version |
|------------|------|---------|
| https://charts.4allportal.net | maxscale | 3.1.1 |
...
| webdav.image.tag | string | `"2.4.53"` |  |
...
| backups.s3.image.repository | string | `"jess/s3cmd@sha256"` |  |
| backups.s3.image.tag | string | `"ed9c4389bedf382edf1c243ac9c95b042725a564773c7ffc2ea01ed17152bded"` |  |
