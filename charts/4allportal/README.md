...
![Version: 18.2.2](https://img.shields.io/badge/Version-18.2.2-informational?style=flat-square) ![AppVersion: 3.10.8](https://img.shields.io/badge/AppVersion-3.10.8-informational?style=flat-square)
...
|------------|------|---------|
| https://4allportal.github.io/helm-charts | maxscale | 3.1.1 |
...
| backups.s3.image.tag | string | `"latest@sha256:9327b10e6541772fbcded1f9ef9921c15bb416201ae9498554ae74cffb3041c7"` |  |
