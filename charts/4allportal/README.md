...
![Version: 19.0.5](https://img.shields.io/badge/Version-19.0.5-informational?style=flat-square) ![AppVersion: 3.10.26](https://img.shields.io/badge/AppVersion-3.10.26-informational?style=flat-square)
...
|------------|------|---------|
| https://4allportal.github.io/helm-charts | maxscale | 4.0.3 |
...
| backups.s3.image.tag | string | `"latest@sha256:3680bbab23ffbcc247d723ec50661325f3e4f563f8a521285dc44c77e4cf77bd"` |  |
