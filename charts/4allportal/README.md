...
![Version: 18.3.12](https://img.shields.io/badge/Version-18.3.12-informational?style=flat-square) ![AppVersion: 3.10.8](https://img.shields.io/badge/AppVersion-3.10.8-informational?style=flat-square)
...
|------------|------|---------|
| https://4allportal.github.io/helm-charts | maxscale | 3.2.10 |
...
| backups.s3.image.tag | string | `"latest@sha256:99502c94afdeadbed18256f64209fc130fa958735e2ef6ec571811b3ba4ee929"` |  |
