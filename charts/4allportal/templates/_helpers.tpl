...
{{- required "Operator is enabled, please provide a username." .Values.fourAllPortal.database.operator.user -}}
{{- else -}}
{{- required "Operator is disabled, please provide a user for the existing database" .Values.fourAllPortal.database.existing.user -}}
{{- end -}}
{{- end -}}
...
{{- if .Values.fourAllPortal.database.operator.enabled }}
{{- else if and (not .Values.fourAllPortal.database.existing.port) ((list "mysql" "mariadb") | has (include "4allportal.fourallportal.database.type" .)) -}}
3306
{{- else if .Values.fourAllPortal.database.existing.port }}
{{- .Values.fourAllPortal.database.existing.port -}}
{{- else }}
{{- required "Operator is disabled, please provide a port for the existing database" .Values.fourAllPortal.database.existing.port -}}
{{- end -}}
{{- end -}}

{{- define  "4allportal.fourallportal.database.name" -}}
{{- if .Values.fourAllPortal.database.operator.enabled }}
{{- required "Operator is enabled, please provide a name for the database" .Values.fourAllPortal.database.operator.databaseName -}}
{{- else -}}
{{- required "Operator is disabled, please provide a name for the existing database" .Values.fourAllPortal.database.existing.name -}}
{{- end -}}
{{- end -}}
...
{{- eq (include "4allportal.component.isHa" .Values.fourAllPortal) "true" -}}
{{- end -}}
