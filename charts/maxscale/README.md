...
![Version: 4.0.13](https://img.shields.io/badge/Version-4.0.13-informational?style=flat-square) ![Type: application](https://img.shields.io/badge/Type-application-informational?style=flat-square) ![AppVersion: 22.08.3](https://img.shields.io/badge/AppVersion-22.08.3-informational?style=flat-square)
...
| mariadb-galera.configurationConfigMap | string | `"innodb_buffer_pool_size={{ mulf .Values.mariadb.resources.limits.memory 0.8 }}G"` |  |
